    ...
    <div class="main-panel">
      ...
      <?php
        ...
        if (isset($_GET['id'])) {
          ...
          $stid = oci_parse($koneksi,"SELECT * FROM MHS WHERE NIM = '$id'");
          oci_execute($stid);
         while (($d = oci_fetch_array($stid, OCI_BOTH)) != false) {
          ?>
      <form class="form-horizontal" action="proses_update_mhs.php" method="post">
       <div class="form-row">
        ...
        <input type="text" class="form-control" name="gender" value="<?= $d['GENDER'] ?>">
        </div>        
        </div>
        <div class="form-row">
        <div class="form-group col-md-6">
        ...
        <div class="form-group col-md-6">
          ...
          <input type="text" class="form-control" name="tanggal_lahir" value="<?= $d['TANGGAL_LAHIR'] ?>">
        </div>        
        </div>          
          <div class="form-row">
        <div class="form-group col-md-6">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-6">
            <input type="submit" name="submit" class="btn btn-sm btn-primary" value="updated" >           
          </div>
        </div>
      </form>
         <?php }
