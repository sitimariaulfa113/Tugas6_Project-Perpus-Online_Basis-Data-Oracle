    ...
    <div class="main-panel">
      ...
      <?php
        ...
        if (isset($_GET['id'])) {
          ...
          $stid = oci_parse($koneksi,"SELECT * FROM BUKU WHERE ID_BUKU = '$id'");
          oci_execute($stid);
         while (($d = oci_fetch_array($stid, OCI_BOTH)) != false) {
          ?>
      <form class="form-horizontal" action="proses_update_buku.php" method="post">
       <div class="form-row">
        
        
          <input type="hidden" class="form-control" name="id_buku" value="<?= $d['ID_BUKU'] ?>" >
        ...
        <div class="form-group col-md-6">
          ...
          <input type="text" class="form-control" name="judul_buku" value="<?= $d['JUDUL_BUKU'] ?>">
        </div>
        </div>
        <div class="form-row">
        <div class="form-group col-md-6">
