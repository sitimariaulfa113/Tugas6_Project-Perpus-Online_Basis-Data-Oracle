      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">Data Anggota</a>
          </div>
      ...
      <div class="content">
        <div class="container-fluid">
          <div class="row">
            ...
            <a href="tambah_mhs.php"><button class="btn btn-primary">
                  ...
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                        <?php 
		include 'Koneksi.php';
		$stid = oci_parse($koneksi, 'SELECT * from MHS');
		...
		while (($d = oci_fetch_array ($stid, OCI_BOTH)) != false) {
			?>
                        <tr>                          
                          ...
                          <td class="td-actions">
						  <a href="mhs_update.php?id=<?= $d['NIM'] ?>">
                            <button type="button" rel="tooltip" class="btn btn-success">
                              <i class="material-icons">edit</i>
                            </button></a>
							<a href="delete_mhs.php?id=<?= $d['NIM'] ?>" 
