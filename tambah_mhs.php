    ...
    <div class="main-panel">
      ...
      <!--- tambah data -->
           <div class="card mb-4">
                ...
                <div class="card-body">
      <form method='post' action='proses_tambah_mhs.php?act=input'>
          <input type="hidden" class="form-control" name="NIM" value="<?= $d['NIM'] ?>" >
        ...
        <div class="form-group col-md-6">
          ...
          <input type="text" class="form-control" name="nama_mhs" placeholder="masukan nama mahasiswa">
        </div>

        <div class="form-group col-md-6">
          <label for="">NO_HP</label>
          <input type="text" class="form-control" name="no_hp" placeholder="Contoh : 0896xxxxxxx">      
        </div>   

        <div class="form-group col-md-6">
          <label for="">GENDER</label>
          <input type="text" class="form-control" name="gender" placeholder="Contoh : P / L">
        </div>        
        ...
        <div class="form-group col-md-6">
          ...
          <input type="text" class="form-control" name="tanggal_lahir" placeholder="Contoh : 01/01/2000">
        </div>        
