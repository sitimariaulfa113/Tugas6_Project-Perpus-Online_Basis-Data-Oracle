  ...
  <div class="wrapper ">
    ...
    <div class="main-panel">
      ...
      <!-- End Navbar -->
           ...
           <?php 
      include("Koneksi.php");
      $stid = oci_parse($koneksi, 'select count(*) as JUM from mhs');
      oci_execute($stid);
     ...
     <div class="content">
      ...
      <?php 
        include("Koneksi.php");
        $stid = oci_parse($koneksi, 'select count(*) as JUM from buku');
        oci_execute($stid);
        $total2 = oci_fetch_array($stid,OCI_BOTH);
      ?>
        <div class="col-lg-3 col-md-6 col-sm-6">
      ...
      <?php 
        include("Koneksi.php");
        $stid = oci_parse($koneksi, 'select count(*) as JUM from peminjaman');
        oci_execute($stid);
        $total2 = oci_fetch_array($stid,OCI_BOTH);
      ?>
        <div class="col-lg-3 col-md-6 col-sm-6">
