    ...
    <div class="main-panel">
      ...
      <form method='post' action='proses_tambah_admin.php'>
        ...
        <div class="form-group col-md-6">
          ...
          <input type="text" class="form-control" name="id_petugas" placeholder="masukan ID Admin">
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-6">
            <input type="submit" name="submit" class="btn btn-sm btn-primary" value="Tambah Admin" >           
          </div>
        </div>
      </form>
         <?php 
