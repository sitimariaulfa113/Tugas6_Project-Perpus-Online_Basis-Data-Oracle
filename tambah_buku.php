    ...
    <div class="main-panel">
      ...
      <form method='post' action='proses_tambah_buku.php'>
        ...
        <div class="form-group col-md-6">
          ...
          <input type="text" class="form-control" name="id_buku" placeholder="masukan ID buku">
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-6">
            <input type="submit" name="submit" class="btn btn-sm btn-primary" value="Tambah Buku" >           
          </div>
        </div>
      </form>
         <?php 
